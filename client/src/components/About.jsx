  ...
  return (
    <div className="about container">
      <div className="img-content-block">
        <div className="about__img about__item">
          <img
      ...
      <div className="about__service">
        <div className="social-service-block">
          <div className="social-service">
            ...
            <p className="service-text">
              Meet with one of expert social workers to navigate how to safely
              age in place.
            </p>
          </div>
          <div className="social-service">
            ...
            <p className="service-text">
              Meet with our nurse who can serve as a liasion between you and
        ...
        <div className="social-service-block">
          <div className="social-service">
            ...
            <p className="service-text">
              Meet with a knowledgable benefits volunteer who can determine if
              you qualify for: Medicaid, Food Stamps, Supplemental Security
              Income-SSI.
            </p>
          </div>
          <div className="social-service">
